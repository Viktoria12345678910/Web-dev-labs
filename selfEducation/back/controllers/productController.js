            ...
            try {
                ...
                if (!originalFilename) {
                    ...
                    try {
                        ...
                        console.error(error);
                        res.status(401).json({
                            msg: "Error saving image to cloudinary",
                        });
                    }
                }
            } catch (error) {
...
export const deleteProduct = async (req, res) => {
    ...
    Product.findByIdAndDelete(req.body._id)
        ...
        .catch((err) => {
            ...
            res.status(401).json({ msg: "Error in deleting product" });
        });
};
